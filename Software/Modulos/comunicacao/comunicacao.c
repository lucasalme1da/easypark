...
// assim que o arquivo de leitura tiver terminado de ser escrito, isto sendo
// determinado pelo caracter de fim de comando o que foi escrito deve ser
// retornado.
...
void limpar_arquivo(char* arquivo) { fclose(fopen(arquivo, "w")); }
