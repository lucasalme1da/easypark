...
export default class InterfaceAStar {
    ...
    constructor({nomeAtributoPosicao,nomeAtributoConexoes,funcaoConectarNos,funcaoAdicionaNos,nos,camera, cena, base}){
        ...
        console.log(`
        Precione N para trocar de modo:
        ...
        Precione M para trocar a visibilidade dos nós e conexões, por default eles não estão visíveis

        Precione C para conectar nós previamente selecionados, se o número de nós selecionados for 2 
